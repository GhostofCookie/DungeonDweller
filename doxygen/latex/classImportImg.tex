...
\hypertarget{classImportImg_ac6a2aaa21ea7cc5b439b292e809d3111}{\index{Import\-Img@{Import\-Img}!Get\-Image\-File@{Get\-Image\-File}}
\index{Get\-Image\-File@{Get\-Image\-File}!ImportImg@{Import\-Img}}
\subsubsection[{Get\-Image\-File}]{\setlength{\rightskip}{0pt plus 5cm}string Import\-Img\-::\-Get\-Image\-File (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{classImportImg_ac6a2aaa21ea7cc5b439b292e809d3111}


Function that returns the import image's file path. 

Function that returns the file path. \hypertarget{classImportImg_a20bf0509a73e9c08e89518a2ea9a868a}{\index{Import\-Img@{Import\-Img}!Import@{Import}}
...
\hline
\end{DoxyParams}
\hypertarget{classImportImg_a3e162a2db0984d25d682c48108729da0}{\index{Import\-Img@{Import\-Img}!operator=@{operator=}}
\index{operator=@{operator=}!ImportImg@{Import\-Img}}
\subsubsection[{operator=}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Import\-Img} \& Import\-Img\-::operator= (
\begin{DoxyParamCaption}
\item[{const {\bf Import\-Img} \&}]{img}
\end{DoxyParamCaption}
)}}\label{classImportImg_a3e162a2db0984d25d682c48108729da0}
...
Overloaded assignment operator 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em img} & the image to be copied from \\
\hline
\end{DoxyParams}
