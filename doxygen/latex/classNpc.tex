...
\mbox{\tt in}  & {\em s,the} & stamina of the created \hyperlink{classNpc}{Npc} \\
\hline
\mbox{\tt in}  & {\em g,the} & gold the \hyperlink{classNpc}{Npc} has \\
\hline
\mbox{\tt in}  & {\em h,the} & health of the \hyperlink{classNpc}{Npc} \\
\hline
\mbox{\tt in}  & {\em img,image} & representing the character \\
\hline
\end{DoxyParams}
