...
\hline
\end{DoxyParams}
\hypertarget{classImage_ada292cfbe131d1e84a9f6aaddc22064b}{\index{Image@{Image}!Copy\-Coordinates@{Copy\-Coordinates}}
\index{Copy\-Coordinates@{Copy\-Coordinates}!Image@{Image}}
\subsubsection[{Copy\-Coordinates}]{\setlength{\rightskip}{0pt plus 5cm}virtual void Image\-::\-Copy\-Coordinates (
\begin{DoxyParamCaption}
\item[{const {\bf Image} \&}]{img}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [virtual]}}}\label{classImage_ada292cfbe131d1e84a9f6aaddc22064b}
