...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}, {\ttfamily [virtual]}}}\label{classConnectFour_ad453f2707d1ae7bb87cdd2d46010d951}
...
\hypertarget{classConnectFour_aad3b75c20b82a21fcbe648e7ee134a4b}{\index{Connect\-Four@{Connect\-Four}!Horizontal\-Check@{Horizontal\-Check}}
...
If the column is full, return true, else return false. \hypertarget{classConnectFour_acacb2e213d7c4f6dec2cf2f9d3c370f9}{\index{Connect\-Four@{Connect\-Four}!Left\-Diagonal\-Check@{Left\-Diagonal\-Check}}
...
Height needs to be incremented since we want to place one space above the char that we just found in the grid.

Set the char in the vector grid

Set the char in the screen Height and column are multiplied by 2 since the actual vector has 1/2 as many spots as the grid displayed on the screen does.
...
1/2 as many spots as the grid displayed on the screen does. Add 11 to the top\-Bound to place it in the bottom slot in the grid.

Break the loop \hypertarget{classConnectFour_aeec5d9114f72805796129ebd6e94c6d8}{\index{Connect\-Four@{Connect\-Four}!Output\-Game@{Output\-Game}}
\index{Output\-Game@{Output\-Game}!ConnectFour@{Connect\-Four}}
\subsubsection[{Output\-Game}]{\setlength{\rightskip}{0pt plus 5cm}void Connect\-Four\-::\-Output\-Game (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classConnectFour_aeec5d9114f72805796129ebd6e94c6d8}
Displays the screen containing the gameboard 
\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em Cf\-Screen,the} & screen object used for displaying the mini-\/game \\
\hline
\end{DoxyParams}
\hypertarget{classConnectFour_a618f3caa7db76bc8b4832a2338967a5b}{\index{Connect\-Four@{Connect\-Four}!Play\-A\-I@{Play\-A\-I}}
...
\hypertarget{classConnectFour_a51e2239fa0b4e8c16fb43fe2efb543aa}{\index{Connect\-Four@{Connect\-Four}!Random\-Number@{Random\-Number}}
\index{Random\-Number@{Random\-Number}!ConnectFour@{Connect\-Four}}
\subsubsection[{Random\-Number}]{\setlength{\rightskip}{0pt plus 5cm}int Connect\-Four\-::\-Random\-Number (
\begin{DoxyParamCaption}
\item[{int}]{n}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classConnectFour_a51e2239fa0b4e8c16fb43fe2efb543aa}


Returns a random number between 0 and n-\/1. 

Returns 0 to n-\/1 \hypertarget{classConnectFour_aa563db9c04480dc44a37df28d07c776c}{\index{Connect\-Four@{Connect\-Four}!Reset\-Game@{Reset\-Game}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}}\label{classConnectFour_aa563db9c04480dc44a37df28d07c776c}


Resets the game for another round in the event that the A\-I wins. 

Empty the board of all pieces and fill it with empty spaces. \hypertarget{classConnectFour_ac49d716bde974c19aab3e47e66d94073}{\index{Connect\-Four@{Connect\-Four}!Right\-Diagonal\-Check@{Right\-Diagonal\-Check}}
...
If no 4 of a kind has been found, return false. \hypertarget{classConnectFour_a1e58549ad7980f6a1311c92f5e67e62c}{\index{Connect\-Four@{Connect\-Four}!Run\-Game@{Run\-Game}}
...
Connect\-Four\-Screen stores and outputs the contents of the game to the terminal \hypertarget{classConnectFour_add9742cf2d2ffd9524d454762dbd3154}{\index{Connect\-Four@{Connect\-Four}!grid@{grid}}
