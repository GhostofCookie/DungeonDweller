...
class Menu 
{
 public:
   ...
   * @param[in] f(int) The is the function which adds functionality to the option and command.
   */
...
private:
	/** menu_Array This is the multi-dimensional array to display the menu */
	char** menu_Array;
...
protected:
	...
	/** menuWidth This is the width of the menu. */
	int menuWidth;
};
